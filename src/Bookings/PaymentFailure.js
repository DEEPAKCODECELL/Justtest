...
const PaymentFailure = () => {
    ...
    return (
        <View style={tw`flex-1 justify-center items-center bg-gray-100 p-6`}>
            ...
            <SuccessAnimation />
            <Text style={tw`text-4xl font-bold text-green-600 mt-6`}>failed To Process Paymnet</Text>
            <Text style={tw`text-xl font-bold text-green-600 mt-6`}>If Money get Deducted From Your Account Then It get Returned In 24 Hours Working Hours</Text>
        </View>
    );
};
